...
## Monitor Your Core Web Vitals (LCP, INP, CLS)
**URL:** https://docs.newrelic.com/docs/tutorial-improve-site-performance/guide-to-monitoring-core-web-vitals/
**Summary:** New Relic's guide to CWV measurement and improvement. Covers p75 measurement methodology, session replay correlation for diagnosing CWV failures, and the engineering prioritization process. Documents the NR scorecard rules for LCP, INP, and CLS and their pass/fail thresholds.
