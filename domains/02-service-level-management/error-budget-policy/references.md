...
**Summary:** Google SRE's reference template for a written error budget policy. Establishes standard clauses covering the 20% single-incident threshold that triggers a policy invocation, freeze conditions that halt feature work, escalation paths, and resolution criteria.
