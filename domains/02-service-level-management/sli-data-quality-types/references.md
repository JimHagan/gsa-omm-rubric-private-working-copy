...
## Reliability Engineering Diagnostics: Beginner's Guide
**URL:** https://docs.newrelic.com/docs/new-relic-solutions/observability-maturity/uptime-performance-reliability/diagnostics-beginner-guide/
**Summary:** New Relic's guide to reliability engineering diagnostics. Distinguishes between output performance SLIs (error-free request rate), input performance SLIs (connectivity and upstream dependency availability), and client performance SLIs (end user experience). This three-way distinction is the scoring authority for SLI data quality and multi-layer SLI coverage.
